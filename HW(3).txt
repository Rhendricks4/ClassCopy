        ...
        if self.turn == 1:
            ...
            while True:
                ...
                try:
                    ...
                    if len(parts) != 2:
                        raise ValueError("Need two numbers that are seperated by a comma")
                    r = int(parts[0])
                    c = int(parts[1])

                    if not (0 <= r <= 2 and 0 <= c <= 2):
                        print("Please choose a number between 0 and 2 for both the row and column")
                        continue

                    if self.gameboard.entries[r][c] != 0:
                        print("That space is already occupoied please choose a different space.")
                        continue
                    ...
                    print("Invalid input. Please choose a space like 0,0")
